...
export default class Register extends Component {
    ...
    handleSubmit = (event)=>{
        ...
        const pwdConfirm = event.target[2].value
        if (pwd !== pwdConfirm) {
            return ;
        }
        axios.post('/api/register', {name, pwd}).then(
            response => {
        ...
        return (
            <div id='loginOrRegister'>
                ...
                <Form.Item>
                    ...
                    <Link to="/login" style={{marginLeft:'40px'}} >已有账户,立即登录</Link>
